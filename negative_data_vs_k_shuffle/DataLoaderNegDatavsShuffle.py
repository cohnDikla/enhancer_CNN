...
base_path = base_path[:-len("/negative_data_vs_k_shuffle")]
...
class DataLoaderNegDatavsShuffle(DataLoaderH3K27acvsNeg):
    """
    ...
    def get_all_positive_and_negative_samples(self):
        ...
        original_samples_dir = os.path.join(base_path, "negative_data_vs_k_shuffle", "data", "samples")
        ...
        for species_name in self.project.species:
            species_dir = os.path.join(original_samples_dir, species_name)
            samples_path = os.path.join(species_dir, self.project.k_let_dirs[self.project.k-1],
                                        "negative_samples")
