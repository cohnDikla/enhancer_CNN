"""
Creates the TF data vs. the new negative non-enhancers data, for all species.
...
import os
import sys
from DataLoaderTFvsShuffle import DataLoaderTFvsShuffle
# get the directory of the script being run:
base_path = os.path.dirname(os.path.abspath(__file__))
projects_base_path = base_path[:-len('/TF_vs_k_shuffle')]
