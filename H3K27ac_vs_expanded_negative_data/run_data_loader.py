"""
Creates the H3K27ac data vs. the expanded negative data (non-enhancers + k-shuffle), for all species.
...
import os
import sys
from DataLoaderH3K27acvsExpandedNeg import DataLoaderH3K27acvsExpandedNeg
# get the directory of the script being run:
base_path = os.path.dirname(os.path.abspath(__file__))
projects_base_path = base_path[:-len('/H3K27ac_vs_expanded_negative_data')]
